  	...
  	<div>
		...
		<div className = ' bracket w-100 w-60-ns tl pr1 pr4-ns pl1 pl4-ns pb4 '>
    		...
    		<div className = "frontfont gray pt3 f2 f1-ns pb2 pl2 " style = {{color: 'gray'}} >Programmes we offer..</div>
				...
				As we understand that every school and project have different needs we have 4 programs which vary in topic and length 
				</div>
				...
				<table className ="pa2 frog">
					  ...
					  <tr className="no-bottom-border">
						...
						Participants are shown various images such as the Mona Lisa, a £10 note and a pearl and are asked the value of it, leading into an explanation on an individual’s pricelessness. This leads into a video on how pearls and diamonds are made and how pressure creates strength. This section ends with how self-discipline affects our thoughts and help students be healtier and happier 
						Next we cover Her Bra and Kemi discusses the moment she realised that a bra was not a sexual object to be leered at but part of a woman’s uniform and it could be as pretty or as basic as she desired but it was not just meant for others, it was Hers. An interactive poll is taken on how many girls feel like they know their bra size. How to choose the right bra is then explained, this leads into Her Period  and another interactive poll is taken to show who thinks they understand how their period works. A woman’s menstrual cycle is explained and this leads into the final session of Her-Self-esteem which is HerPurpose, here it is explained that every person has a purpose and the balance between dreaming big and implementing basic healthy habits into our lives
						The programme ends with a Q&A session.
						Topics covered: Her Period, Her Bra and Her Self-esteem.
				...
				<table>
					  ...
					  <tr>
					    <td>Aims</td>
					    <td>
					    Help girls to develop their self-esteem, build and establish their confidence, help them to understand their personal value and unlock hidden potential
   					 </td>
					  </tr>
					  <tr className="no-bottom-border">
					    <td>Course Summary</td>
					    <td >
					    This programme takes the time to look at each topic in Her Self-esteem and really build a young person’s self-esteem. Each session is centered around a topic and the room is decorated to fit with theme 
						<ul>
						...
						Topics covered: Growth, Dreams and the Future <br></br>
				...
				<table>
					  ...
					  <tr className="no-bottom-border">
					    <td>Course Summary</td>
					    <td>
					    This session focuses on the Her Self-esteem module teaching the young women about their Worth, Strength and Purpose.
						Participants first discuss the value of various objects and then the value and learn interesting fun facts about their own body which leads to the conclusion that each person is in fact priceless. A jar of positive affirmations is passed around for them pick one and keep.
						Her Strength highlights emotional intelligence and resilience using a video on pearl and diamond creation. Kemi shares her own experience in not valuing her emotions and teaches on how to make good decsions when you don't feel like it. 
						Lastly this session ends with HerPurpose invites the participants to dream Big whilst teaching them the value of a seed whether it be an idea or a task and how that can grow, this is shown with an interactive example with a plant pot.
						The programme ends with a Q&A session.
				...
				<table>
					  ...
					  <tr className="no-bottom-border">
					    <td>Course Summary</td>
					    <td>
					    In this programme we take what is taught in the Her Basics and spend more time explaining the value of our bodies and how this relates to Her Bra and Her Period
