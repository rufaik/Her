  	...
  	<div>
		...
		<div className = ' bracket tl pr4 pl4 pb4 '>
      		...
      		<h2 className = "pa4 pt2 pl4">
				...
				<br></br><br></br>Kemi created HerBasics because she kept having conversations with her young people and women her own age and notices gap of knowledge and a pattern of low self-esteem. Frustrated she crafted the curriculum using tools she had learnt from the Shine program an accredited female empowerment programme and her own experience.

				<br></br><br></br>HerBasics found that many women from the ages of 20- 60 do not have the basic knowledge on how to pick the right bra, what actually happens at that time of the month and what their worth actually is. Our mission is to equip young women everywhere with the basic information on their periods, bras and self-worth so that as they grow they can build on this foundational knowledge make confident and educated decisions on what works for them.

				<br></br><br></br>The main tools used in the programmes are
				<ul>
				<li>Delivery of assemblies</li>
				<li>Videos and interactive activities</li>
				<li>Introductions to techniques and brands that will help them after we leave
				</li>
				<li>Complimentary gifts including, discounts for underwear brands, tampons and pads and a handwritten positive affirmation i.e My strength comes from my resilience
				</li></ul>
